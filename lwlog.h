...
#define lwlog_emerg(M, ...)   fprintf(stderr, RED    "[EMERGENCY]   " "%s (%s:%d) " NONE M YELLOW " errno: %s\n" NONE, __func__, __FILE__, __LINE__, ##__VA_ARGS__, clean_errno());
#define lwlog_alert(M, ...)   fprintf(stderr, PURPLE "[ALERT]       " "%s (%s:%d) " NONE M YELLOW " errno: %s\n" NONE, __func__, __FILE__, __LINE__, ##__VA_ARGS__, clean_errno());
#define lwlog_crit(M, ...)    fprintf(stderr, YELLOW "[CRITICAL]    " "%s (%s:%d) " NONE M YELLOW " errno: %s\n" NONE, __func__, __FILE__, __LINE__, ##__VA_ARGS__, clean_errno());
